...
var request_yelp = function(set_parameters, callback) {
  ...
  var signature = oauthSignature.generate(httpMethod, url,
    parameters, process.env.consumerSecret, process.env.tokenSecret, { encodeSignature: false});
...
console.log(body.location.display_address);
...
//new_data.businesses.map((restaurant)=>{
